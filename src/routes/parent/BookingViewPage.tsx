...
export default function BookingViewPage() {
   ...
   * 보낸 값으로 안다. 이게 있어야 목록으로 돌아갈 수 있다.
   *
   * 없을 수도 있다 — 예전에 받은 주소를 즐겨찾기에서 여는 경우다. 그때는 돌아갈 곳을
   * 모르므로 신청 내용만 보여준다.
   */
    ...
    <>
      ...
      <div className="page page--narrow">
        <div className="stack stack--lg">
          ...
          <div className="card stack">
            <h1>{booking.student_name} 학생 신청 내용</h1>
            <p className="muted">
              아래 내용으로 접수되었습니다. 같은 기기에서 링크를 다시 여시면 언제든 볼 수 있습니다.
            </p>
          </div>
